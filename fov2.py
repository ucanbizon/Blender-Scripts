...
#        print(cam.name)
        ...
        if(isfirst == 0):
            ...
            print(cam.name)
            isfirst = isfirst + 1
            intersection_obj = obj.copy()
            intersection_obj.data = obj.data.copy()
            intersection_obj.animation_data_clear()
            intersection_obj.name = "intersect"
            bpy.context.collection.objects.link(intersection_obj)
